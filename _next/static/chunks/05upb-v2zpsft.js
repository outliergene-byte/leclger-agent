(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 983033, (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", {
        value: !0
    });
    let n = (0, e.r(420262).getDeploymentId)();
    ...
    let n = e.r(191788),
        ...
        a = ({
            ...
            let [r, a] = (0, n.useState)(null);
            return (0, n.useEffect)(() => {
                let e = document.createElement(t);
                return document.body.appendChild(e), a(e), () => {
                    document.body.removeChild(e)
                }
            }, [t]), r ? (0, o.createPortal)(e, r) : null
        };
                    ...
                    ! function(e, t) {
                        ...
                        for (let e = 0; e < t.length; e++) {
                            let r = function({
                                ...
                                (0, a.setAttributesFromProps)(r, t);
                                let {
                                    children: n,
                                    dangerouslySetInnerHTML: o
                                } = t;
                                return o ? r.innerHTML = o.__html || "" : n && (r.textContent = "string" == typeof n ? n : Array.isArray(n) ? n.join("") : ""), r
                            }(t[e]);
    ...
    var a = {
        ...
        UNDERSCORE_GLOBAL_ERROR_ROUTE: function() {
            return l.UNDERSCORE_GLOBAL_ERROR_ROUTE
        },
        UNDERSCORE_GLOBAL_ERROR_ROUTE_ENTRY: function() {
            return l.UNDERSCORE_GLOBAL_ERROR_ROUTE_ENTRY
        },
        UNDERSCORE_NOT_FOUND_ROUTE: function() {
            return l.UNDERSCORE_NOT_FOUND_ROUTE
        },
        UNDERSCORE_NOT_FOUND_ROUTE_ENTRY: function() {
            return l.UNDERSCORE_NOT_FOUND_ROUTE_ENTRY
        }
    };
    ...
    class p {
        ...
        getDataHref(e) {
            ...
            if ("/" !== h[0]) throw Object.defineProperty(Error(`Route name should start with a "/", got "${h}"`), "__NEXT_ERROR_CODE", {
                value: "E303",
                enumerable: !1,
                configurable: !0
            });
            return t = e.skipInterpolation ? m : (0, s.isDynamicRoute)(h) ? (0, i.interpolateAs)(_, m, p).result : h, r = (0, u.default)((0, f.removeTrailingSlash)((0, l.addLocale)(t, d)), ".json"), (0, a.addBasePath)(`/_next/data/${this.buildId}${r}${E}`, !0)
        }
        _isSsg(e) {
    ...
    function E({
        ...
        let n = (0, u.useRef)(r.isAutoExport),
            o = (0, u.useMemo)(() => {
                let e, r = n.current;
                if (r && (n.current = !1), (0, s.isDynamicRoute)(t.pathname) && (t.isFallback || r && !t.isReady)) return null;
                try {
    ...
    class X extends T.default.Component {
        ...
        componentDidMount() {
            this.scrollToHash(), n.isSsr && (o.isFallback || o.nextExport && ((0, b.isDynamicRoute)(n.pathname) || location.search || 1) || o.props && o.props.__N_SSG && (location.search || 1)) && n.replace(n.pathname + "?" + String((0, I.assign)((0, I.urlQueryToSearchParams)(n.query), new URLSearchParams(location.search))), a, {
                _h: 1,
    ...
    async function q(t = {}) {
        o = JSON.parse(document.getElementById("__NEXT_DATA__").textContent), window.__NEXT_DATA__ = o, p = o.defaultLocale;
        let r = o.assetPrefix || "";
        self.__next_set_public_path__(`${r}/_next/`), a = (0, N.getURL)(), (0, x.hasBasePath)(a) && (a = (0, w.removeBasePath)(a)); {
            let {
                normalizeLocalePath: t
            } = e.r(392090), {
                detectDomainLocale: r
            } = e.r(988448), {
                parseRelativeUrl: n
            } = e.r(469590), {
                formatUrl: i
            ...
            if (o.locales) {
                let e = n(a),
                    u = t(e.pathname, o.locales);
                u.detectedLocale ? (e.pathname = u.pathname, a = i(e)) : p = o.locale;
                let l = r(!1, window.location.hostname);
                l && (p = l.defaultLocale)
            }
        }
        if (o.scriptLoader) {
        ...
        i = new v.default(o.buildId, r);
        let s = ([e, t]) => i.routeLoader.onEntrypoint(e, t);
    ...
    function V({
        ...
        let t = T.default.useMemo(() => (0, F.adaptForAppRouterInstance)(n), []);
        return (0, R.jsx)(X, {
            fn: e => z({
                App: f,
                err: e
                        ...
                        children: (0, R.jsx)(B.PathParamsContext.Provider, {
                            ...
                            children: (0, R.jsx)(y.RouterContext.Provider, {
                                ...
                                children: (0, R.jsx)(P.HeadManagerContext.Provider, {
                                    value: l,
                                    children: (0, R.jsx)(D.ImageConfigContext.Provider, {
                                        value: {
    ...
    function z(t) {
        ...
        return console.error(u), console.error("A client-side exception has occurred, see here for more info: https://nextjs.org/docs/messages/client-side-exception-occurred"), i.loadPage("/_error").then(({
            page: n,
            styleSheets: o
        }) => s ? .Component === n ? e.A(648761).then(n => e.A(828805).then(e => (t.App = r = e.default, n))).then(e => ({
            ...
            return Promise.resolve(t.props ? .err ? t.props : (0, N.loadGetInitialProps)(r, s)).then(r => ec({ ...t,
                err: u,
                Component: e,
                styleSheets: i,
                props: r
    ...
    function K({
        ...
        return T.default.useLayoutEffect(() => e(), [e]), null
    }
    let Q = "beforeRender",
        Z = "afterRender",
        J = "afterHydrate",
    ...
    function ei() {
        [Q, J, Z, ee].forEach(e => performance.clearMarks(e))
    }

    function eu() {
        N.ST && (performance.mark(J), performance.getEntriesByName(Q, "mark").length && (performance.measure("Next.js-before-hydration", "navigationStart", Q), performance.measure(et, Q, J)), d && performance.getEntriesByName(et).forEach(d), ei())
    }
    ...
    function el() {
        ...
        e.length && (performance.getEntriesByName(Q, "mark").length && (performance.measure(er, e[0].name, Q), performance.measure(en, Q, Z), d && (performance.getEntriesByName(en).forEach(d), performance.getEntriesByName(er).forEach(d))), ei(), [er, en].forEach(e => performance.clearMeasures(e)))
    }
    ...
    function es({
        ...
        return T.default.useLayoutEffect(() => e.forEach(e => e()), [e]), t
    }
    ...
    function ec(e) {
        ...
        let h = (0, R.jsxs)(R.Fragment, {
            children: [(0, R.jsx)(K, {
                ...
                children: [Y(i, p), (0, R.jsx)(g.Portal, {
        ...
        return t = u, r = e => (0, R.jsx)(es, {
            callbacks: [e, m],
            children: (0, R.jsx)(T.default.StrictMode, {
                children: h
            })
        }), N.ST && performance.mark(Q), o = r(ea ? eu : el), eo ? (0, T.default.startTransition)(() => {
            eo.render(o)
    ...
    async function ef(e) {
        if (e.err && (void 0 === e.Component || !e.isHydratePass)) return void await z(e);
        try {
            await ec(e)
        } catch (r) {
            let t = (0, j.getProperError)(r);
    ...
    async function ed(e) {
        ...
        try {
            ...
            f = t, r && r.reportWebVitals && (d = ({
                ...
                let s, c = `${Date.now()}-${Math.floor(Math.random()*(9e12-1))+1e12}`;
                ...
                l && (f.attribution = l), r.reportWebVitals(f)
            });
        ...
        e ? .beforeRender && await e.beforeRender(), ef(r)
    }("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 974020, (e, t, r) => {
    ...
    function n() {
        return new Promise(e => {
            var t;
            t = function() {
                for (var t = document.querySelectorAll("[data-next-hide-fouc]"), r = t.length; r--;) t[r].parentNode.removeChild(t[r]);
                e()
    ...
    Object.defineProperty(r, "__esModule", {
        value: !0
    }), Object.defineProperty(r, "displayContent", {
        enumerable: !0,
        get: function() {
            return n
        }
...
//# sourceMappingURL=0upuadz64aq1g.js.map