(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 978509, (e, t, r) => {
            ...
            return n(s, "_invoke", function(t, n, o) {
                var a, u, s, i = 0,
                    ...
                    p = {
                        ...
                        f: d.bind(e, 4),
                        d: function(t, r) {
                            return a = t, u = 0, s = e, p.n = r, c
                        }
                    };

                function d(t, n) {
                    for (u = t, s = n, r = 0; !f && i && !o && r < l.length; r++) {
                        var o, a = l[r],
                            d = p.p,
                            v = a[2];
                        t > 3 ? (o = v === n) && (s = a[(u = a[4]) ? 5 : (u = 3, 3)], a[4] = a[5] = e) : a[0] <= d && ((o = t < 2 && d < a[1]) ? (u = 0, p.v = n, p.n = a[1]) : d < v && (o = t < 3 || a[0] > n || n > v) && (a[4] = t, a[5] = n, p.n = v, u = 0))
                    }
                    if (o || t > 1) return c;
                    throw f = !0, n
                }
            ...
            return r[n] = (0, a.default)(o.default.mark(function r() {
                ...
                return o.default.wrap(function(r) {
                    for (;;) switch (r.prev = r.next) {
                        ...
                        case 9:
                            throw r.prev = 9, r.t0 = r.catch(0), t.error("adapter_error_".concat(n), r.t0), (c = new v(r.t0)).name = "".concat(y(n), "Error"), c;
                        case 15:
                        case "end":
                            return r.stop()
                    }
    ...
    }, r.capitalize = y, r.eventsErrorHandler = function(e, t) {
    ...
    var v = r.UnknownError = function(e) {
        function t(e) {
            var r, n;
    ...
    r.OAuthCallbackError = function(e) {
        ...
        return (0, f.default)(t, e), (0, i.default)(t)
    }(v), r.AccountNotLinkedError = function(e) {
        function t() {
            var e;
            (0, s.default)(this, t);
            for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
        ...
        return (0, f.default)(t, e), (0, i.default)(t)
    }(v), r.MissingAPIRoute = function(e) {
        function t() {
            var e;
            (0, s.default)(this, t);
            for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
        ...
        return (0, f.default)(t, e), (0, i.default)(t)
    }(v), r.MissingAuthorize = function(e) {
        function t() {
            var e;
            (0, s.default)(this, t);
            for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
        ...
        return (0, f.default)(t, e), (0, i.default)(t)
    }(v), r.MissingAdapterMethods = function(e) {
        function t() {
            var e;
            (0, s.default)(this, t);
            for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
        ...
        return (0, f.default)(t, e), (0, i.default)(t)
    }(v), r.UnsupportedStrategy = function(e) {
        function t() {
            var e;
            (0, s.default)(this, t);
            for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
        ...
        return (0, f.default)(t, e), (0, i.default)(t)
    }(v), r.InvalidCallbackUrl = function(e) {
        function t() {
            var e;
            (0, s.default)(this, t);
            for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
    ...
    }, r.apiBaseUrl = l, r.fetchData = function(e, t, r) {
    ...
    function c() {
        return (c = (0, u.default)(o.default.mark(function e(t, r, n) {
            var a, u, s, c, f, p, d, v, h, y = arguments;
            return o.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    case 0:
                        return u = (a = y.length > 3 && void 0 !== y[3] ? y[3] : {}).ctx, c = void 0 === (s = a.req) ? null == u ? void 0 : u.req : s, f = "".concat(l(r), "/").concat(t), e.prev = 2, d = {
                            headers: i({
    ...
    r.SessionContext = void 0, r.SessionProvider = function(e) {
        ...
        E._lastSync = f ? (0, g.now)() : 0;
        var d = y.useState(function() {
                return f && (E._session = e.session), e.session
            }),
            x = (0, h.default)(d, 2),
            b = x[0],
            w = x[1],
        ...
        y.useEffect(function() {
            return E._getSession = (0, v.default)(p.default.mark(function e() {
                    var t, r, n = arguments;
                    return p.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (t = (n.length > 0 && void 0 !== n[0] ? n[0] : {}).event, e.prev = 1, !((r = "storage" === t) || void 0 === E._session)) {
                                    e.next = 10;
                                    break
                                }
                                return E._lastSync = (0, g.now)(), e.next = 7, R({
                                    broadcast: !r
                                });
                            case 7:
                                return E._session = e.sent, w(E._session), e.abrupt("return");
                            case 10:
                                if (!(!t || null === E._session || (0, g.now)() < E._lastSync)) {
                                    e.next = 12;
                                    break
                                }
                                return e.abrupt("return");
                            case 12:
                                return E._lastSync = (0, g.now)(), e.next = 15, R();
                            case 15:
                                E._session = e.sent, w(E._session), e.next = 22;
                                break;
                            case 19:
                                e.prev = 19, e.t0 = e.catch(1), k.error("CLIENT_SESSION_ERROR", e.t0);
                            case 22:
        ...
        var A = (t = y.useState("u" > typeof navigator && navigator.onLine), n = (r = (0, h.default)(t, 2))[0], o = r[1], a = function() {
                return o(!0)
            }, u = function() {
                return o(!1)
            }, y.useEffect(function() {
        ...
        var L = y.useMemo(function() {
            return {
                data: b,
                status: P ? "loading" : b ? "authenticated" : "unauthenticated",
                update: function(e) {
                    return (0, v.default)(p.default.mark(function t() {
                        ...
                        return p.default.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    return S(!0), t.t0 = g.fetchData, t.t1 = E, t.t2 = k, t.next = 8, T();
                                case 8:
        ...
        return (0, _.jsx)(M.Provider, {
            value: L,
            children: s
        })
    }, r.getCsrfToken = T, r.getProviders = L, r.getSession = R, r.signIn = function(e, t, r) {
        return N.apply(this, arguments)
    }, r.signOut = function(e) {
        return I.apply(this, arguments)
    }, r.useSession = function(e) {
        if (!M) throw Error("React Context is unavailable in Server Components");
        var t = y.useContext(M),
            r = null != e ? e : {},
            n = r.required,
    ...
    var E = {
            baseUrl: (0, b.default)(null != (n = i.default.env.NEXTAUTH_URL) ? n : i.default.env.VERCEL_URL).origin,
            basePath: (0, b.default)(i.default.env.NEXTAUTH_URL).path,
            baseUrlServer: (0, b.default)(null != (o = null != (a = i.default.env.NEXTAUTH_URL_INTERNAL) ? a : i.default.env.NEXTAUTH_URL) ? o : i.default.env.VERCEL_URL).origin,
            basePathServer: (0, b.default)(null != (u = i.default.env.NEXTAUTH_URL_INTERNAL) ? u : i.default.env.NEXTAUTH_URL).path,
            _lastSync: 0,
            _session: void 0,
            _getSession: function() {}
        },
        j = (0, g.BroadcastChannel)(),
        k = (0, x.proxyLogger)(x.default, E.basePath),
        M = r.SessionContext = null == (s = y.createContext) ? void 0 : s.call(y, void 0);
    ...
    function A() {
        return (A = (0, v.default)(p.default.mark(function e(t) {
            ...
            return p.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    case 0:
                        return e.next = 2, (0, g.fetchData)("session", E, k, t);
                    case 2:
                        return n = e.sent, (null == (r = null == t ? void 0 : t.broadcast) || r) && j.post({
                            event: "session",
                            data: {
                                trigger: "getSession"
                            }
    ...
    function U() {
        return (U = (0, v.default)(p.default.mark(function e(t) {
            ...
            return p.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    case 0:
                        return e.next = 2, (0, g.fetchData)("csrf", E, k, t);
                    case 2:
    ...
    function C() {
        return (C = (0, v.default)(p.default.mark(function e() {
            return p.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    case 0:
                        return e.next = 2, (0, g.fetchData)("providers", E, k);
                    case 2:
    ...
    function N() {
        return (N = (0, v.default)(p.default.mark(function e(t, r, n) {
            var o, a, u, s, i, c, l, f, d, v, h, y, x, b, _, w, m;
            return p.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    case 0:
                        return u = void 0 === (a = (o = null != r ? r : {}).callbackUrl) ? window.location.href : a, i = void 0 === (s = o.redirect) || s, c = (0, g.apiBaseUrl)(E), e.next = 4, L();
                    case 4:
                        if (l = e.sent) {
                            e.next = 8;
                            break
                    ...
                    case 11:
                        return f = "credentials" === l[t].type, d = "email" === l[t].type, v = f || d, h = "".concat(c, "/").concat(f ? "callback" : "signin", "/").concat(t), y = "".concat(h).concat(n ? "?".concat(new URLSearchParams(n)) : ""), e.t0 = fetch, e.t1 = y, e.t2 = {
                            "Content-Type": "application/x-www-form-urlencoded"
                        }, e.t3 = URLSearchParams, e.t4 = S, e.t5 = S({}, r), e.t6 = {}, e.next = 25, T();
                    case 25:
                    ...
                    case 33:
                        return x = e.sent, e.next = 36, x.json();
                    case 36:
                        if (b = e.sent, !(i || !v)) {
                            e.next = 42;
                            break
                        }
                        return w = null != (_ = b.url) ? _ : u, window.location.href = w, w.includes("#") && window.location.reload(), e.abrupt("return");
                    case 42:
                        if (m = new URL(b.url).searchParams.get("error"), !x.ok) {
                            e.next = 46;
                            break
                        }
                        return e.next = 46, E._getSession({
                            event: "storage"
                        });
                    case 46:
                        return e.abrupt("return", {
    ...
    function I() {
        return (I = (0, v.default)(p.default.mark(function e(t) {
            ...
            return p.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    case 0:
                        return o = void 0 === (n = (null != t ? t : {}).callbackUrl) ? window.location.href : n, a = (0, g.apiBaseUrl)(E), e.t0 = {
                            "Content-Type": "application/x-www-form-urlencoded"
                    ...
                    case 23:
                        return e.next = 25, E._getSession({
                            event: "storage"
                        });
                    case 25:
    ...
    e.s(["hasNextPage", 0, function(e, t) {
        ...
        return {
            onFetch: (o, a) => {
                let u = o.options,
                    s = o.fetchOptions ? .meta ? .fetchMore ? .direction,
                    i = o.state.data ? .pages || [],
                    c = o.state.data ? .pageParams || [],
                    l = {
                        pages: [],
                        pageParams: []
                    },
                    ...
                    p = async () => {
                        let a = !1,
                            p = (0, t.ensureQueryFn)(o.options, o.fetchOptions),
                            d = async (e, r, n) => {
                                ...
                                Object.defineProperty(u, "signal", {
                                    enumerable: !0,
                                    get: () => (o.signal.aborted ? a = !0 : o.signal.addEventListener("abort", () => {
                                        a = !0
                                    }), o.signal)
                                });
                                let s = await p(u),
                        ...
                        if (s && i.length) {
                            ...
                            let t = e ? ? i.length;
                            do {
                                let e = 0 === f ? c[0] ? ? u.initialPageParam : r(u, l);
                                if (f > 0 && null == e) break;
                                l = await d(l, e), f++
                            } while (f < t)
                        }
                ...
                o.options.persister ? o.fetchFn = () => o.options.persister ? .(p, {
                    client: o.client,
                    queryKey: o.queryKey,
                    meta: o.options.meta,
                    signal: o.signal
...
//# sourceMappingURL=0h16xg0-wzdvc.js.map